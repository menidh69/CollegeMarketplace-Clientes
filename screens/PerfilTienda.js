    ...
    const validartienda = async (estado) => {
        ...
        try {
            ...
            const response = await fetch(
                "http://college-mp-env.eba-kwusjvvc.us-east-2.elasticbeanstalk.com/api/v1/validar_tienda",
                {
                    method: "POST",
                ...
                <View style={styles.modalcontainer}>
                    <View style={styles.modalView}>
                        ...
                        <Text style={styles.modalText}>
                            Esta tienda es nueva, ayudanos a verificarla</Text>
                        <View style={{ flexDirection: "row" }}>
                            <TouchableOpacity
                                style={styles.btnmodal}
                                onPress={() => validartienda("true")}
                            >
                                <Text style={styles.textStyle}>Si existe</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                style={[styles.button, styles.btnmodal]}
                                onPress={() => validartienda("false")}
                            >
