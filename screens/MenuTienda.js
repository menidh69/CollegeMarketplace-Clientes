...
const MenuTienda = ({ route }) => {
    ...
    const fetchitems = async (id) => {
        const data = await fetch(`http://college-marketplace.eba-kd3ehnpr.us-east-2.elasticbeanstalk.com/api/v1/productosTienda/${route.params.tienda.id}`);
...
const Producto = ({ producto }) => {
    ...
    return (
        <>
            <TouchableOpacity onPress={() => navigation.navigate('ProductoInfo', { producto: producto })}>
                <View style={styles.productoContainer} >
                    ...
                    <View style={styles.textoProductoContainer}>
                        ...
                        <Text style={styles.precio}>${Number.parseFloat(producto.precio).toFixed(2)}</Text>
